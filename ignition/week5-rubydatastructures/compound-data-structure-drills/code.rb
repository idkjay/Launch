...
puts "There are #{people.size} people in 'people', excluding children, of course, because they are not people."
# * What are the names of all the people?
puts "The name of all the people:"
people.each do |name, traits|
  puts name
end
# * What is the phone number of Alia O'Conner PhD?
puts "The phone number of Alia O'Connor PHD is #{people["Alia O'Conner PhD"]["phone"]}."
...
puts "Name of the people who have children: "
people.each do |name, trait|
  if trait.has_key?("children")
    puts name
  end
end
# * What are the names of the people who do not have children?
puts "Name of the people who do not have children: "
people.each do |name, trait|
  if !trait.has_key?("children")
    puts name
  end
...
puts "There are #{sets_of_people[0].size} people in the first set of people."
# * How many people are in the second set of people?
puts "There are #{sets_of_people[1].size} people in the second set of people."
...
puts "The people in the first set that have an 'm' in their company name are:"
sets_of_people[0].each do |name, trait|
  if trait["company"].include?("m") || trait["company"].include?("M")
    puts name
  end
end
